...
````
100 - (avg by (instance) (rate(node_cpu_seconds_total{job="nodeexporter",mode="idle"}[10s])) * 100)
````
CPULA 1/5/15
````
node_load1{instance="nodeexporter", job="nodeexporter"}
...
![](https://github.com/mgesler/devops-netology/blob/main/pic/dash1.jpg)
Задание 3
...
````
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "100 - (avg by (instance) (rate(node_cpu_seconds_total{job=\"nodeexporter\",mode=\"idle\"}[10s])) * 100)\n",
          "interval": "",
          "legendFormat": "",
          "refId": "A"
        }
  ...
  "time": {
    "from": "2022-08-17T07:26:02.486Z",
    "to": "2022-08-17T16:17:15.899Z"
  },
  "timepicker": {},
  "timezone": "",
